...
La carpeta Docs almacena toda la documentación relevante para el desarrollo, implementación y mantenimiento del proyecto. Incluye especificaciones técnicas, manuales de usuario, diagramas y otros documentos clave que facilitan la comprensión del sistema, su configuración y su correcto funcionamiento.
